      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="login_box_img">
            <div class="hover">
              <h4>Level Baru Dunia Laundry!</h4>
              <p>Bukan deterjen biasa — ini solusi cepat, wangi tahan lama, dan hemat setiap tetesnya.<br>
              Biar cucianmu wangi maksimal, tanpa ribet.</p>
              <a class="button button-account" href="/gohappymart/login/regis">Create an Account</a>
            </div>
          </div>
        </div>
          ...
          <div class="login_form_inner">
            ...
            <form class="row login_form" action="#/" id="contactForm">
              ...
              <div class="col-md-12 form-group">
                ...
                <a href="/gohappymart/login/lupa" class="text-primary" style="display:block; margin-top:10px; text-align:right;">Forgot Password?</a>
              </div>
