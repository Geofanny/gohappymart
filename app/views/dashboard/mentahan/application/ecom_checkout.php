...
<head>
  <title>Checkout | Mantis Bootstrap 5 Admin Template</title>
  <!-- [Meta] -->
  <meta charset="utf-8">
                        ...
                        <table class="table" id="pc-dt-simple">
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <div class="media align-items-center">
                                  <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-1.png" alt="image"
                        ...
                        <li class="list-group-item px-0">
                          <div class="media align-items-start">
                            <img class="bg-light rounded img-fluid wid-60"
                              src="/gohappymart/public/assets/dashboard/images/application/prod-img-1.png" alt="User image">
                                  ...
                                  <div class="form-check">
                                    ...
                                    <label class="form-check-label d-block" for="customCheckdef12">
                                      <span class="d-flex align-items-center">
                                        ...
                                        <img src="/gohappymart/public/assets/dashboard/images/application/card.png" alt="img"
                                  ...
                                  <div class="form-check">
                                    ...
                                    <label class="form-check-label d-block" for="customCheckdef11">
                                      <span class="d-flex align-items-center">
                                        ...
                                        <img src="/gohappymart/public/assets/dashboard/images/application/paypal.png" alt="img"
                                          class="img-fluid ms-1">
                                      </span>
                                    </label>
                                  </div>
                                  ...
                                  <div class="form-check">
                                    ...
                                    <label class="form-check-label d-block" for="customCheckdef13">
                                      <span class="d-flex align-items-center">
                                        ...
                                        <img src="/gohappymart/public/assets/dashboard/images/application/cod.png" alt="img"
                                          class="img-fluid ms-1">
                                      </span>
                                    </label>
                                  </div>
                                ...
                                <div class="card paycard">
                                  <div class="card-body p-3">
                                    <div class="d-flex align-items-start justify-content-between">
                                      <h5>John Smith</h5>
                                      <img src="/gohappymart/public/assets/dashboard/images/application/mastercard.png" alt="images"
                                        class="img-fluid">
                                    </div>
                                ...
                                <div class="card paycard">
                                  <div class="card-body p-3">
                                    <div class="d-flex align-items-start justify-content-between">
                                      ...
                                      <img src="/gohappymart/public/assets/dashboard/images/application/visa.png" alt="images" class="img-fluid">
                                    </div>
                                    <div class="row g-2 align-items-center justify-content-between my-2">
                                      <div class="col">
                                        <h5 class="mb-0">****</h5>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="card my-2 coupon-card border border-secondary"
                    style="background-image: url('/gohappymart/public/assets/dashboard/images/application/discount.png')">
                    <div class="card-body">
