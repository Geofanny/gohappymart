...
<head>
  <title>Products | Mantis Bootstrap 5 Admin Template</title>
  <!-- [Meta] -->
  <meta charset="utf-8">
            ...
            <div class="ecom-content">
              ...
              <div class="row">
                <div class="col-sm-6 col-xl-4">
                  <div class="card product-card">
                    <div class="card-img-top">
                      <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-1.png" alt="image" class="img-prod">
                ...
                <div class="col-sm-6 col-xl-4">
                  <div class="card product-card">
                    <div class="card-img-top">
                      <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-2.png" alt="image" class="img-prod">
                      <div class="card-body position-absolute end-0 top-0">
                        <div class="form-check prod-likes">
                          <input type="checkbox" class="form-check-input">
                          <i data-feather="heart" class="prod-likes-icon"></i>
                ...
                <div class="col-sm-6 col-xl-4">
                  <div class="card product-card">
                    <div class="card-img-top">
                      <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-3.png" alt="image" class="img-prod">
                      <div class="card-body position-absolute end-0 top-0">
                        <div class="form-check prod-likes">
                          <input type="checkbox" class="form-check-input">
                          <i data-feather="heart" class="prod-likes-icon"></i>
                ...
                <div class="col-sm-6 col-xl-4">
                  <div class="card product-card">
                    <div class="card-img-top">
                      <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-4.png" alt="image" class="img-prod">
                      <div class="card-body position-absolute end-0 top-0">
                        <div class="form-check prod-likes">
                          <input type="checkbox" class="form-check-input">
                          <i data-feather="heart" class="prod-likes-icon"></i>
                ...
                <div class="col-sm-6 col-xl-4">
                  <div class="card product-card">
                    <div class="card-img-top">
                      <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-5.png" alt="image" class="img-prod">
                      <div class="card-body position-absolute end-0 top-0">
                        <div class="form-check prod-likes">
                          <input type="checkbox" class="form-check-input">
                          <i data-feather="heart" class="prod-likes-icon"></i>
                ...
                <div class="col-sm-6 col-xl-4">
                  <div class="card product-card">
                    <div class="card-img-top">
                      <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-6.png" alt="image" class="img-prod">
                      <div class="card-body position-absolute end-0 top-0">
                        <div class="form-check prod-likes">
                          <input type="checkbox" class="form-check-input">
                          <i data-feather="heart" class="prod-likes-icon"></i>
                ...
                <div class="col-sm-6 col-xl-4">
                  <div class="card product-card">
                    <div class="card-img-top">
                      <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-7.png" alt="image" class="img-prod">
                      <div class="card-body position-absolute end-0 top-0">
                        <div class="form-check prod-likes">
                          <input type="checkbox" class="form-check-input">
                          <i data-feather="heart" class="prod-likes-icon"></i>
                ...
                <div class="col-sm-6 col-xl-4">
                  <div class="card product-card">
                    <div class="card-img-top">
                      <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-8.png" alt="image" class="img-prod">
                      <div class="card-body position-absolute end-0 top-0">
                        <div class="form-check prod-likes">
                          <input type="checkbox" class="form-check-input">
                          <i data-feather="heart" class="prod-likes-icon"></i>
                ...
                <div class="col-sm-6 col-xl-4">
                  <div class="card product-card">
                    <div class="card-img-top">
                      <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-9.png" alt="image" class="img-prod">
                      <div class="card-body position-absolute end-0 top-0">
                        <div class="form-check prod-likes">
                          <input type="checkbox" class="form-check-input">
                          <i data-feather="heart" class="prod-likes-icon"></i>
