...
<head>
  <title>Products Details | Mantis Bootstrap 5 Admin Template</title>
  <!-- [Meta] -->
  <meta charset="utf-8">
  ...
  <!-- [Favicon] icon -->
  <link rel="icon" href="/gohappymart/public/assets/dashboard/images/favicon.svg" type="image/x-icon"> <!-- [Google Font] Family -->
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Public+Sans:wght@300;400;500;600;700&display=swap" id="main-font-link">
<!-- [Tabler Icons] https://tablericons.com -->
<link rel="stylesheet" href="/gohappymart/public/assets/dashboard/fonts/tabler-icons.min.css" >
<!-- [Feather Icons] https://feathericons.com -->
<link rel="stylesheet" href="/gohappymart/public/assets/dashboard/fonts/feather.css" >
<!-- [Font Awesome Icons] https://fontawesome.com/icons -->
<link rel="stylesheet" href="/gohappymart/public/assets/dashboard/fonts/fontawesome.css" >
<!-- [Material Icons] https://fonts.google.com/icons -->
<link rel="stylesheet" href="/gohappymart/public/assets/dashboard/fonts/material.css" >
<!-- [Template CSS Files] -->
<link rel="stylesheet" href="/gohappymart/public/assets/dashboard/css/style.css" id="main-style-link" >
  ...
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content">
      ...
      <div class="card text-center">
        <div class="card-body">
          <img src="/gohappymart/public/assets/dashboard/images/img-navbar-card.png" alt="images" class="img-fluid mb-2">
          <h5>Help?</h5>
        ...
        <div class="row g-0">
          <div class="col image-block">
            ...
            <div class="row align-items-end">
              ...
              <div class="col">
                <img src="/gohappymart/public/assets/dashboard/images/mega-menu/chart.svg" alt="image" class="img-fluid img-charts">
              </div>
            </div>
          </div>
          <div class="col">
        ...
        <div class="dropdown-header px-0 text-wrap header-notification-scroll position-relative" style="max-height: calc(100vh - 215px)">
          <div class="list-group list-group-flush w-100">
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="/gohappymart/public/assets/dashboard/images/user/avatar-2.jpg" alt="user-image" class="user-avtar">
                </div>
                <div class="flex-grow-1 ms-1">
                  <span class="float-end text-muted">3:00 AM</span>
                  <p class="text-body mb-1">It's <b>Cristina danny's</b> birthday today.</p>
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="/gohappymart/public/assets/dashboard/images/user/avatar-1.jpg" alt="user-image" class="user-avtar">
                </div>
                <div class="flex-grow-1 ms-1">
                  <span class="float-end text-muted">6:00 PM</span>
                  <p class="text-body mb-1"><b>Aida Burg</b> commented your post.</p>
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="/gohappymart/public/assets/dashboard/images/user/avatar-3.jpg" alt="user-image" class="user-avtar">
                </div>
                <div class="flex-grow-1 ms-1">
                  <span class="float-end text-muted">2:45 PM</span>
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="/gohappymart/public/assets/dashboard/images/user/avatar-4.jpg" alt="user-image" class="user-avtar">
                </div>
                <div class="flex-grow-1 ms-1">
                  <span class="float-end text-muted">9:10 PM</span>
                  <p class="text-body mb-1"><b>Cristina Danny </b> invited to join <b> Meeting.</b></p>
      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
        <div class="dropdown-header">
          <div class="d-flex mb-1">
            <div class="flex-shrink-0">
              <img src="/gohappymart/public/assets/dashboard/images/user/avatar-2.jpg" alt="user-image" class="user-avtar wid-35">
            </div>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide ecomm-prod-slider"
                      ...
                      <div class="carousel-inner bg-light rounded">
                        ...
                        <div class="carousel-item active">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-1.png" class="d-block"
                            alt="Product images">
                        </div>
                        <div class="carousel-item">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-2.png" class="d-block"
                            alt="Product images">
                        </div>
                        <div class="carousel-item">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-3.png" class="d-block"
                            alt="Product images">
                        </div>
                        <div class="carousel-item">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-4.png" class="d-block"
                            alt="Product images">
                        </div>
                        <div class="carousel-item">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-5.png" class="d-block"
                            alt="Product images">
                        </div>
                        <div class="carousel-item">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-6.png" class="d-block"
                            alt="Product images">
                        </div>
                        <div class="carousel-item">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-7.png" class="d-block"
                            alt="Product images">
                        </div>
                        <div class="carousel-item">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-8.png" class="d-block"
                            alt="Product images">
                        </div>
                      </div>
                      <ol class="carousel-indicators position-relative product-carousel-indicators my-sm-3 mx-0">
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="0"
                          ...
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-1.png" class="d-block wid-50 rounded"
                            alt="Product images">
                        </li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="1" class="w-25 h-auto">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-2.png" class="d-block wid-50 rounded"
                            alt="Product images">
                        </li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="2" class="w-25 h-auto">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-3.png" class="d-block wid-50 rounded"
                            alt="Product images">
                        </li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="3" class="w-25 h-auto">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-4.png" class="d-block wid-50 rounded"
                            alt="Product images">
                        </li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="4" class="w-25 h-auto">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-5.png" class="d-block wid-50 rounded"
                            alt="Product images">
                        </li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="5" class="w-25 h-auto">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-6.png" class="d-block wid-50 rounded"
                            alt="Product images">
                        </li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="6" class="w-25 h-auto">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-7.png" class="d-block wid-50 rounded"
                            alt="Product images">
                        </li>
                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="7" class="w-25 h-auto">
                          <img src="/gohappymart/public/assets/dashboard/images/application/prod-img-8.png" class="d-block wid-50 rounded"
                            alt="Product images">
                        </li>
                      </ol>
                    </div>
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="ecomtab-4" role="tabpanel" aria-labelledby="ecomtab-tab-4">
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="media align-items-start">
                            <img class="img-radius img-fluid wid-40" src="/gohappymart/public/assets/dashboard/images/user/avatar-1.jpg"
                              alt="User image">
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="media align-items-start">
                            <img class="img-radius img-fluid wid-40" src="/gohappymart/public/assets/dashboard/images/user/avatar-2.jpg"
                              alt="User image">
                            <div class="media-body ms-3">
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="media align-items-start">
                            <img class="img-radius img-fluid wid-40" src="/gohappymart/public/assets/dashboard/images/user/avatar-3.jpg"
                              alt="User image">
                            <div class="media-body ms-3">
              ...
              <div class="card rel-prod-card">
                ...
                <div class="card-body rel-prod-list">
                  <div class="media align-items-start mb-3">
                    <img class="bg-light rounded img-fluid wid-60" src="/gohappymart/public/assets/dashboard/images/application/prod-img-1.png"
                      alt="User image">
                  ...
                  <div class="media align-items-start mb-3">
                    <img class="bg-light rounded img-fluid wid-60" src="/gohappymart/public/assets/dashboard/images/application/prod-img-2.png"
                      alt="User image">
                    <div class="media-body mx-2">
                      <h5 class="mb-1">Canon EOS 1500D 24.1 Digital SLR</h5>
                      <p class="text-truncate text-muted text-sm mb-2">SLR Camera (Black) with</p>
                  ...
                  <div class="media align-items-start mb-3">
                    <img class="bg-light rounded img-fluid wid-60" src="/gohappymart/public/assets/dashboard/images/application/prod-img-3.png"
                      alt="User image">
                    <div class="media-body mx-2">
                      <h5 class="mb-1">Canon EOS 1500D 24.1 Digital SLR</h5>
                      <p class="text-truncate text-muted text-sm mb-2">SLR Camera (Black) with</p>
                  ...
                  <div class="media align-items-start mb-3">
                    <img class="bg-light rounded img-fluid wid-60" src="/gohappymart/public/assets/dashboard/images/application/prod-img-4.png"
                      alt="User image">
                    <div class="media-body mx-2">
                      <h5 class="mb-1">Canon EOS 1500D 24.1 Digital SLR</h5>
                      <p class="text-truncate text-muted text-sm mb-2">SLR Camera (Black) with</p>
                  ...
                  <div class="media align-items-start mb-3">
                    <img class="bg-light rounded img-fluid wid-60" src="/gohappymart/public/assets/dashboard/images/application/prod-img-5.png"
                      alt="User image">
                    <div class="media-body mx-2">
                      <h5 class="mb-1">Canon EOS 1500D 24.1 Digital SLR</h5>
                      <p class="text-truncate text-muted text-sm mb-2">SLR Camera (Black) with</p>
                  ...
                  <div class="media align-items-start mb-3">
                    <img class="bg-light rounded img-fluid wid-60" src="/gohappymart/public/assets/dashboard/images/application/prod-img-6.png"
                      alt="User image">
                    <div class="media-body mx-2">
                      <h5 class="mb-1">Canon EOS 1500D 24.1 Digital SLR</h5>
                      <p class="text-truncate text-muted text-sm mb-2">SLR Camera (Black) with</p>
              ...
              <div class="pct-content">
                <div class="theme-color themepreset-color theme-layout">
                  <a href="#!" class="active" onclick="layout_change('light')" data-value="false"
                    ><span><img src="/gohappymart/public/assets/dashboard/images/customization/default.svg" alt="img"></span><span>Light</span></a
                  >
                  <a href="#!" class="" onclick="layout_change('dark')" data-value="true"
                    ><span><img src="/gohappymart/public/assets/dashboard/images/customization/dark.svg" alt="img"></span><span>Dark</span></a
                  >
                </div>
              </div>
            </div>
              ...
              <div class="pct-content">
                <div class="theme-color preset-color">
                  <a href="#!" class="active" data-value="preset-1"
                    ><span><img src="/gohappymart/public/assets/dashboard/images/customization/theme-color.svg" alt="img"></span><span>Theme 1</span></a
                  >
                  <a href="#!" class="" data-value="preset-2"
                    ><span><img src="/gohappymart/public/assets/dashboard/images/customization/theme-color.svg" alt="img"></span><span>Theme 2</span></a
                  >
                  <a href="#!" class="" data-value="preset-3"
                    ><span><img src="/gohappymart/public/assets/dashboard/images/customization/theme-color.svg" alt="img"></span><span>Theme 3</span></a
                  >
                  <a href="#!" class="" data-value="preset-4"
                    ><span><img src="/gohappymart/public/assets/dashboard/images/customization/theme-color.svg" alt="img"></span><span>Theme 4</span></a
                  >
                  <a href="#!" class="" data-value="preset-5"
                    ><span><img src="/gohappymart/public/assets/dashboard/images/customization/theme-color.svg" alt="img"></span><span>Theme 5</span></a
                  >
                  <a href="#!" class="" data-value="preset-6"
                    ><span><img src="/gohappymart/public/assets/dashboard/images/customization/theme-color.svg" alt="img"></span><span>Theme 6</span></a
                  >
                  <a href="#!" class="" data-value="preset-7"
                    ><span><img src="/gohappymart/public/assets/dashboard/images/customization/theme-color.svg" alt="img"></span><span>Theme 7</span></a
                  >
                  <a href="#!" class="" data-value="preset-8"
                    ><span><img src="/gohappymart/public/assets/dashboard/images/customization/theme-color.svg" alt="img"></span><span>Theme 8</span></a
                  >
                  <a href="#!" class="" data-value="preset-9"
                    ><span><img src="/gohappymart/public/assets/dashboard/images/customization/theme-color.svg" alt="img"></span><span>Theme 9</span></a
                  >
                </div>
              </div>
            </div>
            ...
            <div class="collapse show" id="pctcustcollapse4">
              <div class="pct-content">
                <div class="theme-color themepreset-color boxwidthpreset theme-container">
                  <a href="#!" class="active" onclick="change_box_container('false')" data-value="false"><span><img src="/gohappymart/public/assets/dashboard/images/customization/default.svg" alt="img"></span><span>Fluid</span></a>
                  <a href="#!" class="" onclick="change_box_container('true')" data-value="true"><span><img src="/gohappymart/public/assets/dashboard/images/customization/container.svg" alt="img"></span><span>Container</span></a>
                </div>
              </div>
            </div>
          </li>
