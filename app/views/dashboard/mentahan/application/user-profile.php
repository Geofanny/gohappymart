      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="card profile-wave-card">
            <img src="/gohappymart/public/assets/dashboard/images/profile/img-profile-top.svg" alt="images"
              class="img-fluid profille-wave-img wave-top">
            <img src="/gohappymart/public/assets/dashboard/images/profile/img-profile-bottom.svg" alt="images"
                ...
                <div class="card-body position-relative">
                  <div class="text-center">
                    <div class="chat-avtar d-inline-flex mx-auto">
                      <img class="rounded-circle img-fluid wid-120" src="/gohappymart/public/assets/dashboard/images/user/avatar-5.jpg"
                        alt="User image">
                    </div>
                                  ...
                                  <label class="form-check-label d-block" for="customCheckdef1">
                                    <span class="d-flex align-items-center justify-content-between">
                                      ...
                                      <span class="d-inline-flex align-items-center">
                                        <span class="mx-3"
                                          style="background: url('/gohappymart/public/assets/dashboard/images/application/card.png'); width: 33px; height: 20px;"></span>
                                ...
                                <div class="form-check">
                                  ...
                                  <label class="form-check-label d-block" for="customCheckdef2">
                                    <span class="d-flex align-items-center justify-content-between">
                                      ...
                                      <span class="d-inline-flex align-items-center">
                                        <span class="mx-3"
                                          style="background: url('/gohappymart/public/assets/dashboard/images/application/card.png'); width: 33px; height: 20px; background-position: right;"></span>
                                        <a href="#" class="avtar avtar-xs btn-link-danger">
                                          <i class="ti ti-trash f-18"></i>
                                        </a>
                                      </span>
...
<script>font_change("Public-Sans");</script>
  ...
  <script src="/gohappymart/public/assets/dashboard/js/plugins/choices.min.js"></script>
  <script>
    (function () {
      var options = {
        series: [30],
