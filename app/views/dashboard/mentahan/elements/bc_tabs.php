...
<head>
  <title>Tabs &amp; Pills | Mantis Bootstrap 5 Admin Template</title>
  <!-- [Meta] -->
  <meta charset="utf-8">
        ...
        <div class="col-xl-9">
          <div class="row">
            <div class="col-md-10 col-xxl-9 mb-4">
              ...
              <h2>Tabs &amp; Pills</h2>
              <p class="text-muted">Takes the basic nav from above and adds the .nav-tabs class to generate a tabbed interface.</p>
              <div>
                <a class="btn btn-sm btn-light-dark rounded-pill px-2" role="button" target="_blank" href="https://getbootstrap.com/docs/5.3/components/navs-tabs/">
