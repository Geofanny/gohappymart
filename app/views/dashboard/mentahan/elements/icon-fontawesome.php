...
<html lang="en">
  <!-- [Head] start -->
  <head>
    <title>Font Awesome Icon Pack | Mantis Bootstrap 5 Admin Template</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Font Awesome</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Font Awesome</h2>
                </div>
              </div>
            </div>
          </div>
