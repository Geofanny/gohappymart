...
<html lang="en">
  <!-- [Head] start -->
  <head>
    <title>Horizontal Layout | Mantis Bootstrap 5 Admin Template</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Horizontal Layout</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Horizontal Layout</h2>
                </div>
              </div>
            </div>
          </div>
...
<script>font_change("Public-Sans");</script>
 ...
 <div class="offcanvas pct-offcanvas offcanvas-end" tabindex="-1" id="offcanvas_pc_layout">
  ...
  <div class="pct-body" style="height: calc(100% - 60px)">
    ...
    <script src="/gohappymart/public/assets/dashboard/js/layout-horizontal.js"></script>
  </body>
  <!-- [Body] end -->
</html>
