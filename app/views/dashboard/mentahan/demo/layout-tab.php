  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="../dashboard/index.html" class="b-brand">
        ...
        <img src="/gohappymart/public/assets/dashboard/images/logo-dark.svg" alt="" class="logo logo-lg">
        <img src="/gohappymart/public/assets/dashboard/images/favicon.svg" alt="" class="logo logo-sm">
      </a>
    </div>
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Tab Layout</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Tab Layout</h2>
                </div>
              </div>
            </div>
          </div>
...
<script>font_change("Public-Sans");</script>
 ...
 <div class="offcanvas pct-offcanvas offcanvas-end" tabindex="-1" id="offcanvas_pc_layout">
  ...
  <div class="pct-body" style="height: calc(100% - 60px)">
    ...
    <script src="/gohappymart/public/assets/dashboard/js/layout-tab.js"></script>
  </body>
  <!-- [Body] end -->
</html>
