...
<html lang="en">
  ...
  <head>
    <title>Vector Map | Mantis Bootstrap 5 Admin Template</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
    ...
    <!-- map-vector css -->
    <link rel="stylesheet" href="/gohappymart/public/assets/dashboard/css/plugins/jsvectormap.min.css">
    <!-- [Google Font] Family -->
...
<script>font_change("Public-Sans");</script>
    ...
    <script src="/gohappymart/public/assets/dashboard/js/plugins/jsvectormap.min.js"></script>
    <script src="/gohappymart/public/assets/dashboard/js/plugins/world.js"></script>
    <script src="/gohappymart/public/assets/dashboard/js/plugins/world-merc.js"></script>
    <script src="/gohappymart/public/assets/dashboard/js/pages/canada.js"></script>
    <script src="/gohappymart/public/assets/dashboard/js/pages/iraq.js"></script>
    <script src="/gohappymart/public/assets/dashboard/js/pages/italy.js"></script>
    <script src="/gohappymart/public/assets/dashboard/js/pages/russia.js"></script>
    <script src="/gohappymart/public/assets/dashboard/js/pages/spain.js"></script>
    <script src="/gohappymart/public/assets/dashboard/js/pages/us-aea-en.js"></script>
    <script src="/gohappymart/public/assets/dashboard/js/pages/us-lcc-en.js"></script>
    <script src="/gohappymart/public/assets/dashboard/js/pages/us-merc-en.js"></script>
    <script src="/gohappymart/public/assets/dashboard/js/pages/us-mill-en.js"></script>
    
    <script src="/gohappymart/public/assets/dashboard/js/pages/map-vector.js"></script>
