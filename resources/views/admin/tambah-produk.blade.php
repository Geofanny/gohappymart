...
@section('content')
    <div class="col-12 mt-2">
        <div class="card shadow-sm">
            <div class="card-body">
                <h1 class="mb-3"><i class="ti ti-plus me-2"></i> Tambah Produk</h1>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="id_kategori" name="id_kategori" class="form-control" required>
                                ...
                                @foreach ($kategori as $k)
                                    <option value="{{ $k->id_kategori }}">{{ ucwords($k->nama) }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="sku" name="sku"
                                placeholder="Contoh: SKU001" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="stok" name="stok"
                                placeholder="Masukkan stok tersedia" required min="0">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mt-3" style="margin-bottom: -3vh">
                                <div id="previewCard" class="card d-none border"
                        ...
                        <div class="col-12 mt-4 d-flex justify-content-between">
                            <a href="/dashboard-admin/produk" class="btn btn-secondary">Kembali</a>
